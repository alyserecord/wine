...
The recommender was deployed on an AWS EC2 instance where users can interact with the recommender searching for their favorite wines and receiving recommendations. The recommender can be accessed [here](http://ec2-18-220-108-175.us-east-2.compute.amazonaws.com:8105/).
